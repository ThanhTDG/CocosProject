...
const { isArrived, getMoveStepByDirection, getMoveStepToTarget, validateVector } = require("../../utils/vectorUtils");
...
cc.Class({
    ...
    updateMovement(dt) {
        ...
        if (this.targetPosition) {
            moveStep = getMoveStepToTarget(currentPosition, this.targetPosition, speed, dt);
